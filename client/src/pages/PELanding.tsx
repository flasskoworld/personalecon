      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 md:h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            <img src="/evergreen-icon.png" alt="Evergreen Icon" style={{width:"36px",height:"36px",objectFit:"contain"}}/>
            <div>
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <img src="/evergreen-icon.png" alt="Evergreen Icon" style={{width:"24px",height:"24px",objectFit:"contain"}}/>
            <span
              style={{
                fontFamily: "'Syne', sans-serif",
                fontSize: "12px",
